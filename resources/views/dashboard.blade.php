...
@section('title', 'اللوحة الرئيسية - نظام MgaSoft')
...
<div class="dashboard-container">
    ...
    <div class="welcome-card">
        ...
        <p>نظام MgaSoft لإدارة الحسابات والمبيعات ونقاط البيع المتكامل. يمكنك الوصول السريع إلى كافة العمليات والتقارير من خلال هذه اللوحة.</p>
    </div>
